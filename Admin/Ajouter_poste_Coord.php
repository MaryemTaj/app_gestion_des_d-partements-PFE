...
if((!empty($nom_poste))&&(!empty($max_vote))&&(!empty($id_election))&&(!empty($id_filiere)))
{
...
condition_anciennete) 
 VALUES (
 NULL,'$nom_poste','$description', NULL,'$max_vote','$id_election',NULL,'$id_filiere','$type_prof','$condition_specialite','$grade','$condition_anciennete')";
         
		$inser=$db->query($sql);
			$_SESSION['success']="<strong style=color:green>la candidature $nom_poste  $ajouter_coord est ajouté</strong>";
