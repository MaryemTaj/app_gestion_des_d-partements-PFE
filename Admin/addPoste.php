                                        ...
                                        <div class="form-group">
												...
												<div class="selectgroup selectgroup-pills">
													...
													<label class="selectgroup-item">
														<input type="checkbox" name="condition_type_prof[]" value="professeur enseignement supérieur" class="selectgroup-input">
														<span class="selectgroup-button">professeur enseignement supérieur</span>
													</label>
													<label class="selectgroup-item">
