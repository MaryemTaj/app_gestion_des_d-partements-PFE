	...
	<section class="ftco-section">
		<div class="container">
            ...
            <?php } else {?>
  			...
  			<input type="password" class="form-control" id="pwd2" placeholder="Recipient's username" name="password" aria-label="Recipient's username" aria-describedby="basic-addon2">
