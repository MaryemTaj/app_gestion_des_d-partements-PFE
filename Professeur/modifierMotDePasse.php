	...
	<div class="wrapper">
		<div class="main-header">
			...
			<div class="logo-header" data-background-color="blue">
				...
				<a href="index.html" class="logo">
					 <img src="images/fac.png" style="width: 100%; height: 60%; background-color: white; border-radius: 5px;" alt="navbar brand" 
				     class="navbar-brand">
				</a>
					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Bienvenue dans la platforme de gestion des departements</h5>
							</div>
							<div class="ml-md-auto py-2 py-md-0">
								<a href="" class="btn btn-white btn-border btn-round mr-2">Accréditation d'une filière</a>
								<a href="acceuil_vote.php" class="btn btn-secondary btn-round">Espace de Vote</a>
							</div>
						</div>
					</div>
				</div>
        ...
        <div class="card  ">
          ...
          <div class="row">
              ...
              <div class="col">
              <h5 class="card-title">Formulaire de Modification de mot de de mot de passe</h5>
              <form action="updatePsswd.php" id="form" class="shadow p-3 mb-5 bg-white rounded" method="post">
              <div class="form-group">
                <label for="pwd">Nouveau mot de passe:</label>
				
				
				<div class="input-group mb-3">
  <input type="password" name="password1" id="pwd" name="password1" class="form-control" placeholder="Recipient's username" aria-label="Recipient's username" aria-describedby="basic-addon2">
  <div class="input-group-append">
    <span class="input-group-text" id="basic-addon2"><input type="checkbox" onclick="myFunction1()"></span>
  </div>
</div>
    
              </div>
              <div class="form-group">
			  <label for="validationDefaultUsername">Confirmer votre mot de passe</label>
			  <div class="input-group mb-3">
  <input type="password" class="form-control" id="pwd2" placeholder="Recipient's username" name="password2" aria-label="Recipient's username" aria-describedby="basic-addon2">
  <div class="input-group-append">
    <span class="input-group-text" id="basic-addon2"><input type="checkbox" onclick="myFunction2()"></span>
  </div>
...
<script type="text/javascript">
                ...
                {
                    $.post( "../Admin/checkSession.php", function( data ) {

                        if(data == "-1")
                        {
							<?php $message='Votre session est expiree'?>
                            window.location.href = '../login/index.php?message=<?=$message?>';
