	...
	<div class="wrapper">
        ...
        <div class="col-md-4">
             ...
             echo '<img style="width:250px; border-radius: 50%; margin-top:30%;" class="img-circle img-thumbnail isTooltip"
              src="../images/'.$_SESSION['professeur']['Image'] .'"/>'; ?>
                ...
                <tbody>
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['professeur']['nomPrenom_prof'].'</strong>';?>     
                        </td>
                    </tr>
                    <tr>    
                        <td>
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['professeur']['CIN_prof'].'</strong>';?>     
                        </td>
                    </tr>
                    <tr>        
                        <td>
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['professeur']['email'].'</strong>';?>  
                        </td>
                    </tr>
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['professeur']['tele'].'</strong>';?> 
                        </td>
                    </tr> 
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['professeur']['ville'].'</strong>';?> 
                        </td>
                    </tr>      
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['professeur']['specialite'].'</strong>';?> 
                        </td>
                    </tr>      
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['professeur']['grade'].'</strong>';?> 
                        </td>
                    </tr>                        
                </tbody>
            </table>
