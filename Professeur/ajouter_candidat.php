...
$professeur=$_SESSION['professeur']['id_prof'];
$poste=$_POST['poste'];
...
$specialite_prof = $_SESSION['professeur']['specialite'];
$grade_prof  = $_SESSION['professeur']['grade'];
$annciennete_prof = $_SESSION['professeur']['anciennete'];
$type_prof = $_SESSION['professeur']['type_prof'];
