					...
					<div class="page-inner py-5">
						<div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
							<div>
								...
								<h5 class="text-white op-7 mb-2">Bienvenue dans la l'espace des élections des departements  </h5>
							</div>
							...
							<div class="ml-md-auto py-2 py-md-0">
								...
								<a href="lancerVote.php?id_election=<?php echo  $row->id_election?>&amp;date_election=<?php echo  $row->date_election?>" class="btn btn-secondary btn-round">Espace de Vote</a><?php ;}}?>
							</div>
						...
						<div class="card text-center">
							<?php
	                                    ...
	                                    foreach ($election as $row) {?>
                                            	<div class="card-body">
		                           <h5 class="card-title"><?php echo $row->nom_election ?></h5>
		                           <p class="card-text">la facultés des sciences éonomique et juridique sociales ain sebaa lançe la candidature pour les postes </p>
		                   <a href="poste.php?id_election=<?php echo $row->id_election ?>&amp;date_election=<?php echo $row->date_election ?>&amp;date_fin_insc=<?php echo $row->date_fin_insc ?>&amp;date_debut_insc=<?php echo $row->date_debut_insc ?>" class="btn btn-primary">Voir les postes</a>
	                            </div>
	                        <div class="card-footer text-muted ">
		                   <span style="color:red;">*</span>dernier délai pour s'inscrire sur les listes electorales : 
		                   <?php echo 'du    ' .'<code class="h5" style="color:red;">'.$row->date_debut_insc     .'</code>' . '   au     <code code class="h5" style="color:red;">'.$row->date_debut_insc .'</code>';?>
	                        </div>
	                        <div class="card-footer text-muted ">
		                   ...
		                   <?php echo '<code class="h5" style="color:red;">'.$row->date_election     .'</code>';
                                 ...
                                 <div class="card-body">
		                           <h5 class="card-title"> Aucun election !</h5>
		                           <p class="card-text"> </p>
