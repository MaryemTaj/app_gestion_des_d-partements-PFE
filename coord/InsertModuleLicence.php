...
if(isset($_SESSION['coordFiliere']) && isset($_SESSION['nouvelleFiliere']['etape5'])){
  ?>
<html lang="en">
<head>
		...
		<div class="main-panel">
			<div class="content">
                ...
                <div class="card">
                    ...
                    <div class=row>
                        <div class="col-md-6 border-right">
                            ...
                            <form method="post"class="needs-validation" action="InsertModuleLicence.php">
				<div class="form-row">
				...
				<div class="form-groupe col-md-4">
                    ...
                    <input type="number" required  step="0.10" name="Coefficient" class="form-control" id="Coefficient" placeholder="Coefficient">
                    </div>
                </div>
				<div class="form-row">
                     <div class="form-group col-md-4">
				...
				<div class="form-row">
					 ...
					 <input type="number" disabled required   name="VolumeHoraireCours" class="form-control" id="VolumeHoraireCours" placeholder="Volume Horaire du Cours">
                    </div>
                    <div class="form-group col-md-4">
                    <label for="VolumeHoraireTD">Volume Horaire TD</label>
                    <input type="number" disabled required   name="VolumeHoraireTD" class="form-control" id="VolumeHoraireTD" placeholder="VolumeHoraire TD">
                    </div>
					<div class="form-group col-md-4">
                    <label for="VolumeHoraireTP">VolumeHoraireTP</label>
                    <input type="number" disabled required   name="VolumeHoraireTP" class="form-control" id="VolumeHoraireTP" placeholder="VolumeHoraireTP">
                    </div>
                </div>
...
<script>
	$(document).ready(function(){
        ...
        url: 'PercentageModuleLicence.php',
