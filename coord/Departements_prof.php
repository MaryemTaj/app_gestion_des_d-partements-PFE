...
<!---------------------------------------------- navbar & sidebar menu ------------------------------------------------------------------------->
                            ...
                            <div class="panel-header bg-primary-gradient">
                                <div class="page-inner py-5">
                                    <div class="d-flex align-items-left align-items-md-center flex-column flex-md-row">
                                        <div>
										<h2 class="text-white pb-2 fw-bold">Départements</h2>
        ...
        <div class="card">
            <div class="card-bdoy">
			  ...
			  $coord = $_SESSION['coordFiliere']['id_prof'];
				$request = "SELECT DISTINCT id_dprtm, nom_dprtm, intitule_filiere, p.nomPrenom_prof as coordFiliere , l.prof_cours as profc , 
				            l.prof_TD as proft , l.prof_TP as proftt  FROM departement d 
				            INNER JOIN filiere f ON f.id_departement=d.id_dprtm INNER JOIN liste_modules l ON l.id_filiere=f.id_filiere 
				            INNER JOIN professeur p ON f.coorFiliere=p.id_prof where l.prof_cours= '$coord' or l.prof_TD= '$coord' or l.prof_TP= '$coord' ";
    ...
    <thead>
      <tr class="table-primary">
		<th>Département</th>
		<th>Filière</th>
		<th>Coordinateur de Filière</th>
      </tr>
    </thead>
    <tbody>
		<?php foreach ($result as $result) {?>
			<tr>
			<td><?php echo $result['nom_dprtm']; ?></td>
			<td><?php echo $result['intitule_filiere']; ?></td>
			<td><?php echo $result['coordFiliere']; ?></td>
