                 ...
                 <?php 
                       ...
                       $sql = "SELECT * FROM filiere f inner join professeur p on p.id_prof=f.coorFiliere 
						...
						foreach ($fils as $row) {
											...
											<td>   <a href="affecter_mod.php?id_filiere=<?php echo $row->id_filiere ?>" role="button" class="btn btn-primary btn-border"><span class="btn-label"><i class="fas fa-cog"></i></span> gérer</a> </td>
