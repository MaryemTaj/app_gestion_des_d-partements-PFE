...
<!---------------------------------------------- navbar & sidebar menu ------------------------------------------------------------------------->
    ...
    <div class="container-fluid pt-3">
        <div class="card">
			...
			$request = "SELECT * FROM equipe_pedagogique ep INNER JOIN professeur p ON ep.id_equipe=
            p.id_equipe INNER JOIN professeur pp ON ep.coorModule=pp.id_prof where p.id_prof=".$_SESSION['coordFiliere']['id_prof'];
    ...
    <tbody>
		<?php foreach ($result as $result) {?>
			<tr>
			<td><?php echo $result['intitule_equipe']; ?></td>
