...
<!---------------------------------------------- navbar & sidebar menu ------------------------------------------------------------------------->
	...
	<div class="wrapper">
									...
									<li>
										<div class="user-box">
											...
											<div class="u-text">
												...
												<p class="text-muted"><?= $_SESSION['coordFilierer']['email']?></p>
											</div>
										</div>
									</li>
									<li>
		...
		<div style="padding-top: 10%; padding-left: 15%;" class="container bootstrap snippets bootdey">
		<div class="panel-body inf-content">
    	<div class="row">
        <div class="col-md-4">

             <?php
             echo '<img style="width:250px; border-radius: 50%; margin-top:30%;" class="img-circle img-thumbnail isTooltip"
              src="../images/'.$_SESSION['coordFiliere']['Image'] .'"/>'; ?>
                ...
                <tbody>
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['coordFiliere']['nomPrenom_prof'].'</strong>';?>     
                        </td>
                    </tr>
                    <tr>    
                        <td>
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['coordFiliere']['CIN_prof'].'</strong>';?>     
                        </td>
                    </tr>
                    <tr>        
                        <td>
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['coordFiliere']['email'].'</strong>';?>  
                        </td>
                    </tr>
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['coordFiliere']['tele'].'</strong>';?> 
                        </td>
                    </tr>
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['coordFiliere']['ville'].'</strong>';?> 
                        </td>
                    </tr>      
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['coordFiliere']['specialite'].'</strong>';?> 
                        </td>
                    </tr>      
                    ...
                    <tr>        
                        ...
                        <td class="text-primary">
                            <?php echo '<strong>'.$_SESSION['coordFiliere']['grade'].'</strong>';?> 
                        </td>
                    </tr>                    
                </tbody>
            </table>
